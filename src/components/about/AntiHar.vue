                ...
                <p class="google-font" style="font-size:110%">
                    ...
                    <ul class="mt-2" style="font-size:110%">
                        <li class="google-font">Smart Kitchen: <br>
                            Ahorro de tiempo, mayor eficiencia energetica y maxima comodidad, Asi son las cocinas inteligentes con electrodomesticos conectados e informacion en tiempo real en tu smartphone.
                        </li>
                        <li class="google-font">Programacion de AC y calefaccion:<br>
                            Con los termostatos inteligentes se consigue un uso mas sostenible y eficiente de la energia: gracias a una mezcla de sensores, algoritmos y computacion en la nube, aprenden comportamientos y programan la temperatura perfecta en cada momento.
                        </li>
                        <li class="google-font">Sistemas de seguridad:<br>
                            Hogares mas protegidos con camaras conectadas entre si y con aparatos moviles, alarmas automatizadas, video en streaming, almacenamiento cloud y vision nocturna.
                        </li>
                        <li class="google-font">Gestion de la energia fotovoltaica:<br>
                            La energia fotovoltaica que no se utiliza queda almacenada en unas baterias que conectadas con sensores y el movil, informan sobre energia utilizada, acumulada y eficiencia energetica.
                        </li>
                        <li class="google-font">Iluminacion:<br> 
                            Apagado y encendido programado de los sistemas de iluminacion, creacion de ambientes luminicos y aplicaciones para conciliar mejor el sueño y descansar mas.
                        </li>
                        <li class="google-font">Teleasistencia:<br>
                            La conexion de dispositivos entre medico y paciente majora la calidad de vida de las personas que necesitan asistencia medica o viven solos.
                        </li>
                        <li class="google-font">Gimnasio conectado:<br>
                            Una bicicleta estatica se convierte en entrenador personal gracias a IoT, analiza parametros fisicos, propone planes y crea escenarios de competicion con otros usuarios.
                        </li>
                        <li class="google-font">Maletas conectadas:<br>
